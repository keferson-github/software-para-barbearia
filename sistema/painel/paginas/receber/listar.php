...
<td>
		<big><a href="#" onclick="editar('{$id}','{$descricao}', '{$pessoa}', '{$valor}', '{$data_venc}', '{$data_pgto}', '{$tumb_arquivo}', '{$pgto}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>

		<big><a href="#" onclick="mostrar('{$descricao}', '{$valorF}', '{$data_lancF}', '{$data_vencF}',  '{$data_pgtoF}', '{$nome_usuario_lanc}', '{$nome_usuario_pgto}', '{$tumb_arquivo}', '{$nome_pessoa}', '{$foto}', '{$pgto}')" title="Ver Dados"><i class="fa fa-info-circle text-secondary"></i></a></big>
	...
	<big><a class="{$visivel}" href="#" onclick="baixar('{$id}', '{$valor}', '{$descricao}', '{$pgto}')" title="Baixar Conta"><i class="fa fa-check-square verde"></i></a></big>
...
<script type="text/javascript">
	function editar(id, descricao, pessoa, valor, data_venc, data_pgto, foto, pgto){
		$('#id').val(id);
