		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<!-- Primeira Coluna -->
					<div class="col-md-4">
						<div class="modal-dados-row">
							<div class="modal-dados-label">Email:</div>
							<div class="modal-dados-value" id="email_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">Telefone:</div>
							<div class="modal-dados-value" id="telefone_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">CPF:</div>
							<div class="modal-dados-value" id="cpf_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">Ativo:</div>
							<div class="modal-dados-value" id="ativo_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">Endereço:</div>
							<div class="modal-dados-value" id="endereco_dados"></div>
						</div>
					</div>
					...
					<div class="col-md-4">
						<div class="modal-dados-row">
							<div class="modal-dados-label">Senha:</div>
							<div class="modal-dados-value" id="senha_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">Nível:</div>
							<div class="modal-dados-value" id="nivel_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">Data Cadastro:</div>
							<div class="modal-dados-value" id="data_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">Atendimento:</div>
							<div class="modal-dados-value" id="atendimento_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">Tipo Chave PIX:</div>
							<div class="modal-dados-value" id="tipo_chave_dados"></div>
						</div>
						
						<div class="modal-dados-row">
							<div class="modal-dados-label">Chave PIX:</div>
							<div class="modal-dados-value" id="chave_pix_dados"></div>
						</div>
					</div>
					
					<!-- Terceira Coluna - Foto -->
					<div class="col-md-4 text-center">
						<img id="target_mostrar" class="modal-dados-image">
					</div>
				</div>
			</div>
